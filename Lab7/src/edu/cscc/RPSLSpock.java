...
public class RPSLSpock {
    ...
    /**
     * Method to check if pick is valid
     * @param pick pick
     * @return pick (rock, paper, scissors, lizard, or spock)
     */
    ...
    /**
     * Method to choose a random pick
     * @return pick
     */
    ...
    /**
     * Method to determine the criteria in which the computer will win
     * @param c_pick computer pick
     * @param h_pick human pick
     * @return computer win or loss
     */
